...
import { getPersonalProfileService, getUserProfileService, updateUserProfile, userProfile } from "../services/profile.service.js";
...
export const getPersonalProfile = async (req: Request, res: Response) => {
    ...
    try {
        const user = await getPersonalProfileService(req.user.id);
